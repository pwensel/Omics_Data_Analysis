---
title: "Epigenomics EPICS Practical"
...
of respiratory insufficiency in patients with chronic liver disease. 
...
(look in the Phenodata)? That means all, promoter, and promoter plus island (Hint: 
use limma design matrix to assign covariates)
...
IDAT Files->PGChannelSet->MethylSet->RAtioSet (and -> Genomic MethylSet in parallel via Ratioconvert)->Genomic RatioSetBased on the bimodal distribution for diseased_state suggesting good hybridizations all 12 samples passed initial QC.
2. How many probes pass the quality control? Can you specify which is the 
